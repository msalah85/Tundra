	  ...
	  var oSetDT = this.s.dt;
		...
		$(document).bind( "keydown.DTTT", function(e) {
			...
			if ( e.keyCode == 27 )
			{
				...
				$(".hidden-print").css('display', ''); //.removeAttr('style');
			}
		} );
	},
...
TableTools.BUTTONS = {
	...
	"xls": $.extend( {}, TableTools.buttonBase, {
		...
		"sToolTip": "تصدير إكسيل",
		"sButtonText": "<i class='fa fa-save fa-top-grid'></i>",
		"fnClick": function( nButton, oConfig, flash ) {
			this.fnSetText( flash, this.fnGetTableData(oConfig) );
		}
	} ),
	...
	"copy": $.extend( {}, TableTools.buttonBase, {
		...
		"sToolTip": "نسخ الجدول",
		"sButtonText": "<i class='fa fa-copy fa-top-grid'></i>",
		"fnClick": function( nButton, oConfig, flash ) {
			this.fnSetText( flash, this.fnGetTableData(oConfig) );
		},
		"fnComplete": function(nButton, oConfig, flash, text) {
			var
				...
				plural = (len==1) ? "" : "s";
			this.fnInfo( '<h6>تم نسخ البيانات</h6>'+
				'<p>تم نسخ '+len+' حقل'+plural+' إلى الذاكرة.</p>',
				1500
			);
		}
	} ),
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>عرض البيانات قبل الطباعة</h6><p>استخدم (CTRL + P) للطباعة ، أو زر (Esc) للرجوع للصفحة.</p>",
		"sMessage": null,
		"bShowAll": true,
		"sToolTip": "عـرض البيانات للطباعة",
		"sButtonClass": "DTTT_button_print",
		"sButtonText": "<i class='fa fa-print fa-top-grid'></i>",
 ...
 */
TableTools.DEFAULTS = {
	"sSwfPath":        "/Scripts/DataTables/media/swf/copy_csv_xls_pdf.swf",
	"sRowSelect":      "none",
	"sSelectedClass":  null,
	"fnPreRowSelect":  null,
	"fnRowSelected":   null,
