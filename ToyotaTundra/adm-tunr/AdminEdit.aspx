<%@ Page Title=".:: Update Administrator  ::." Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true" CodeFile="AdminEdit.aspx.cs" Inherits="admin_elaf_EmployeesEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table cellspacing="0" cellpadding="0" border="0" width="950px">
            <tbody>
                <!-- Header -->
				<tr>
					<td class="innerContentHead">Edit Administrator</td>
				</tr>
                <!-- Seperator -->
				<tr>
...
<table width="98%" cellspacing="0" cellpadding="8" border="0" class="Grid">
  <tr align="left" valign="top">
    ...
    <td width="81%">
        ...
        &nbsp;<asp:RequiredFieldValidator ControlToValidate="txtEmployeeName" SetFocusOnError="true"  ErrorMessage="Please enter full name." Display="Dynamic" CssClass="red-txt" ValidationGroup="s" ID="RequiredFieldValidator1" runat="server" ></asp:RequiredFieldValidator>
    </td>
  </tr>
    <tr align="left" valign="top" >
    <td>
    ...
    <td>
        ...
        <asp:RequiredFieldValidator ControlToValidate="txtEmployeeName" SetFocusOnError="true"  ErrorMessage="Please select store." Display="Dynamic" 
        CssClass="red-txt" InitialValue="" ValidationGroup="s" ID="RequiredFieldValidator2" runat="server" ></asp:RequiredFieldValidator>
    </td>
  </tr>     
      <tr align="left" valign="top" >
    <td>
    ...
    <td>
        ...
        &nbsp;<asp:RequiredFieldValidator ControlToValidate="txtEmail" SetFocusOnError="True"  ErrorMessage="Please enter Email." Display="Dynamic" CssClass="red-txt" ValidationGroup="s" ID="RequiredFieldValidator7" runat="server" ></asp:RequiredFieldValidator>
        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" SetFocusOnError="True"  
            ControlToValidate="txtEmail" ErrorMessage="Please verify Email." 
  ...
  <tr align="left" valign="top" >
    ...
    <td>
        ...
        &nbsp;<asp:RequiredFieldValidator SetFocusOnError="True"  ControlToValidate="txtUserName" ErrorMessage="Please enter User name." Display="Dynamic" CssClass="red-txt" ValidationGroup="s" ID="RequiredFieldValidator10" runat="server" ></asp:RequiredFieldValidator>
    </td>
  </tr>
  <tr align="left" valign="top" >
    <td>
    ...
    <td>
        ...
        &nbsp;<asp:RequiredFieldValidator SetFocusOnError="True"  ControlToValidate="txtPassword" ErrorMessage="Please enter Password." Display="Dynamic" CssClass="red-txt" ValidationGroup="s" ID="RequiredFieldValidator8" runat="server" ></asp:RequiredFieldValidator>
    </td>
  </tr>
  <tr align="left" valign="top" >
    <td>
  ...
  <tr align="center" valign="top" >
    ...
    <td >
        <asp:Button ID="btnSubmit" CssClass="g-btn" ValidationGroup="s" runat="server" Text="Update data now"  Width="150px"
            onclick="btnSubmit_Click" />
    <a id="A1" runat="server" style="width:100px" href="AdminView.aspx" class="g-btn">Cancel Updating</a>
    </td>
  </tr>
