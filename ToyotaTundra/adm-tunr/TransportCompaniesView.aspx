<%@ Page Title=".:: Manage Transport Companies ::." Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true" CodeFile="TransportCompaniesView.aspx.cs" Inherits="admin_elaf_TransportCompaniesView" %>
...
<tbody>
    <!-- Header -->
	<tr>
		<td class="innerContentHead">Transport Companies >> View list<div class="div-right margin-right">
...
<!-- end search box -->
<center>   
<asp:GridView ID="gvTransportCompanies" runat="server" AutoGenerateColumns="False" 
         Width="98%" CssClass="Grid" onrowcommand="gvTransportCompanies_RowCommand" 
         PageSize="100" 
         onpageindexchanging="gvTransportCompanies_PageIndexChanging" 
         onrowdeleting="gvTransportCompanies_RowDeleting" >
        ...
        <Columns>
            ...
            <asp:TemplateField ItemStyle-Width="40">
                <ItemTemplate>                    
                        <asp:HyperLink ID="HyperLink11" runat="server" NavigateUrl='<%# "payments/" + Eval("TransportID") + "/transport/" + MinutesuaeConcrete.ToSeoUrl(Eval("TransportName")) + ".aspx" %>' Width="23" BorderStyle="None"
            ...
            <asp:TemplateField ItemStyle-Width="40">
                <ItemTemplate>                    
                     <asp:ImageButton ID="lbEdit"
                         CommandArgument='<%# Eval("TransportID") %>' CssClass="showPeriodMsgPopup"  Width="23" BorderStyle="None"
            ...
            <asp:TemplateField HeaderText="Delete" ItemStyle-Width="40">
                 <ItemTemplate>                  
                     <asp:ImageButton ID="LinkButton1"
                         CommandArgument='<%# Eval("TransportID") %>'  Width="23" BorderStyle="None"
