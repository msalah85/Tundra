<%@ Page Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true" CodeFile="Images.aspx.cs"
    Inherits="ProjectImagesAdmin" Title="Administration | Upload Images" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table cellspacing="0" cellpadding="0" border="0" width="98%">
        <tbody>
            <tr>
                <td class="innerContentHead">Cars >> Car Pictures
                    <div class="div-right">
