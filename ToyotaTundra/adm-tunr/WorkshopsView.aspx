<%@ Page Title=".:: View Workshops List ::." Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true" CodeFile="WorkshopsView.aspx.cs" Inherits="admin_elaf_WorkshopsView" %>
...
<tbody>
    <!-- Header -->
	<tr>
		<td class="innerContentHead">Workshops >> View list<div class="div-right margin-right">
...
<asp:GridView ID="gvWorkshops" runat="server" AutoGenerateColumns="False" 
         Width="98%" CssClass="Grid" onrowcommand="gvWorkshops_RowCommand" 
         PageSize="100" 
         onpageindexchanging="gvWorkshops_PageIndexChanging" 
        ...
        <Columns>
            ...
            <asp:TemplateField ItemStyle-Width="40">
                <ItemTemplate>                    
                        <asp:HyperLink ID="HyperLink11" runat="server" NavigateUrl='<%# "payments/" + Eval("WorkshopID") + "/workshop/" + MinutesuaeConcrete.ToSeoUrl(Eval("WorkshopName")) + ".aspx" %>' Width="23" BorderStyle="None"
                            ToolTip="View payments to this workshop" ImageUrl="~/App_Themes/admin/images/payments.png" />
            ...
            <asp:TemplateField ItemStyle-Width="40">
                <ItemTemplate>                    
                    <asp:ImageButton ID="lbEdit"
                         CommandArgument='<%# Eval("WorkshopID") %>' CssClass="showPeriodMsgPopup"  Width="23" BorderStyle="None"
            ...
            <asp:TemplateField HeaderText="Delete" ItemStyle-Width="40">
                 <ItemTemplate>                  
                     <asp:ImageButton ID="LinkButton1"
                         CommandArgument='<%# Eval("WorkshopID") %>'  Width="23" BorderStyle="None"
