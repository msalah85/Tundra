<%@ Page Title=".:: Buyers List ::." Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true" CodeFile="BuyersView.aspx.cs" Inherits="admin_elaf_BuyersView" %>
...
<tbody>
    <!-- Header -->
	<tr>
		<td class="innerContentHead">Buyers >> View list<div class="div-right margin-right"><asp:ImageButton runat="server" ID="btnAddNew" ToolTip="Add new" 
...
<tr valign="top">
     <td>Auction</td>
            <td >
                <asp:DropDownList ID="ddlAuctions" Width="258" runat="server">
                </asp:DropDownList>            
...
<!-- end search box -->
<center>   
<asp:GridView ID="gvBuyers" runat="server" AutoGenerateColumns="False" 
         Width="98%" CssClass="Grid" onrowcommand="gvBuyers_RowCommand" 
         PageSize="100" 
         onpageindexchanging="gvBuyers_PageIndexChanging" 
         onrowdeleting="gvBuyers_RowDeleting" >
        ...
        <Columns>
            ...
            <asp:TemplateField ItemStyle-Width="40">
                <ItemTemplate>            
                        <asp:HyperLink ID="HyperLink11" runat="server" NavigateUrl='<%# "payments/" + Eval("BuyerID") + "/buyer/" + MinutesuaeConcrete.ToSeoUrl(Eval("BuyerName")) + ".aspx" %>' Width="23" BorderStyle="None"
                            ToolTip="View payments to this buyer" ImageUrl="~/App_Themes/admin/images/payments.png" />
            ...
            <asp:TemplateField ItemStyle-Width="40">
                <ItemTemplate>                    
                         ...
                         CommandArgument='<%# Eval("BuyerID") %>' CssClass="showPeriodMsgPopup"  Width="23" BorderStyle="None"
            ...
            <asp:TemplateField HeaderText="Delete" ItemStyle-Width="40">
                 <ItemTemplate>                  
                     <asp:ImageButton ID="LinkButton1"
                         CommandArgument='<%# Eval("BuyerID") %>'  Width="23" BorderStyle="None"
