<%@ Page Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true" 
    CodeFile="SiteLinksAdd.aspx.cs" Inherits="AddSiteLinks" ValidateRequest="false"
    Title=".:: Add new page ::." %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">    
 <table cellspacing="0" cellpadding="0" border="0" width="950px">
            <tbody>
                <!-- Header -->
				<tr>
					<td class="innerContentHead">Add new page</td>
				</tr>
                <!-- Seperator -->
				<tr>
...
<table width="98%" cellspacing="0" cellpadding="8" border="0" class="Grid">
  ...
  <tr align="center" valign="top" >
     <td colspan="2">
        <asp:Button ID="btnSubmit" CssClass="g-btn" ValidationGroup="s" runat="server" Text="Add this page now"  
