<%@ Page Title=".:: Stores Manager ::." Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true" CodeFile="StoresView.aspx.cs" Inherits="admin_elaf_StoresView" %>
...
<tbody>
    <!-- Header -->
	<tr>
		<td class="innerContentHead">Stores >> View List<div class="div-right margin-right">
...
<asp:GridView ID="gvStores" runat="server" AutoGenerateColumns="False" 
         Width="98%" CssClass="Grid" onrowcommand="gvStores_RowCommand" 
         PageSize="100" 
            ...
            <asp:TemplateField ItemStyle-Width="40">
                <ItemTemplate>                    
                        <asp:ImageButton ID="lbEdit"
                         CommandArgument='<%# Eval("StoreID") %>' CssClass="showPeriodMsgPopup" ToolTip="Edit"  Width="23" BorderStyle="None"
            ...
            <asp:TemplateField HeaderText="Delete" ItemStyle-Width="40">
                 <ItemTemplate>                  
                     <asp:ImageButton ID="LinkButton1"
                         CommandArgument='<%# Eval("StoreID") %>'  Width="23" BorderStyle="None"
