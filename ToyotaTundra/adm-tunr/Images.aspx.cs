...
public partial class ProjectImagesAdmin : System.Web.UI.Page
{
    #region "Private Declaration"

    ImagesManager imgObj = new ImagesManager();
        ...
        try
        {
            ...
            for (int i = 0; i < hfc.Count; i++)
            {
                ...
                if (hpf.ContentLength > 0)
                {
                    ...
                    string _path = Server.MapPath("~/Public/image/cars/");
    ...
    private void FillImagesList(int msterID)
    {
        ...
        DataList1.DataSource = imgObj.GetImagesListByCategoryId("cars", msterID);
        DataList1.DataBind();
    }
