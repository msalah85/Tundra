<%@ Page Title=".:: View Exchange Companies List ::." Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true" CodeFile="ExchangeCompaniesView.aspx.cs" Inherits="admin_elaf_ExchangeCompaniesView" %>
...
<tbody>
    <!-- Header -->
	<tr>
		<td class="innerContentHead">Exchange Companies >> View List<div class="div-right margin-right">
...
<!-- end search box -->
<center>   
<asp:GridView ID="gvExchangeCompanies" runat="server" AutoGenerateColumns="False" 
         Width="98%" CssClass="Grid" onrowcommand="gvExchangeCompanies_RowCommand" 
         PageSize="100" 
         onpageindexchanging="gvExchangeCompanies_PageIndexChanging" 
         onrowdeleting="gvExchangeCompanies_RowDeleting" >
            ...
            <asp:TemplateField ItemStyle-Width="40">
                <ItemTemplate>                    
                        <asp:ImageButton ID="lbEdit"
                         CommandArgument='<%# Eval("ExchangeCompanyID") %>' CssClass="showPeriodMsgPopup" ToolTip="Edit"  Width="23" BorderStyle="None"
            ...
            <asp:TemplateField HeaderText="Delete" ItemStyle-Width="40">
                 <ItemTemplate>                  
                     <asp:ImageButton ID="LinkButton1"
                         CommandArgument='<%# Eval("ExchangeCompanyID") %>'  Width="23" BorderStyle="None"
