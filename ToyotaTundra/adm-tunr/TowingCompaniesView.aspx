<%@ Page Title=".:: View Towing Companies List ::." Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true" CodeFile="TowingCompaniesView.aspx.cs" Inherits="admin_elaf_TowingCompaniesView" %>
...
<tbody>
    <!-- Header -->
	<tr>
		<td class="innerContentHead">Towing Companies >> View List<div class="div-right margin-right">
...
<!-- end search box -->
<center>   
<asp:GridView ID="gvTowingCompanies" runat="server" AutoGenerateColumns="False" 
         Width="98%" CssClass="Grid" onrowcommand="gvTowingCompanies_RowCommand" 
         PageSize="100" 
         onpageindexchanging="gvTowingCompanies_PageIndexChanging" 
         onrowdeleting="gvTowingCompanies_RowDeleting" >
        <HeaderStyle CssClass="GridHead" />
        <AlternatingRowStyle CssClass="Grid_alertnative" />
        <Columns>
            <asp:TemplateField>
                <ItemTemplate>                    
                        <%# Eval("TowingCompanyName")%>                    
                </ItemTemplate>
                <HeaderTemplate>                    
                        Name
                </HeaderTemplate>
            ...
            <asp:TemplateField ItemStyle-Width="40">
                <ItemTemplate>                    
                        <asp:HyperLink ID="HyperLink11" runat="server" NavigateUrl='<%# "payments/" + Eval("TowingCompanyID") + "/towing/" + MinutesuaeConcrete.ToSeoUrl(Eval("TowingCompanyName")) + ".aspx" %>' Width="23" BorderStyle="None"
            ...
            <asp:TemplateField ItemStyle-Width="40">
                <ItemTemplate>                    
                    <asp:ImageButton ID="lbEdit"
                         CommandArgument='<%# Eval("TowingCompanyID") %>' CssClass="showPeriodMsgPopup"  Width="23" BorderStyle="None"
            ...
            <asp:TemplateField HeaderText="Delete" ItemStyle-Width="40">
                 <ItemTemplate>                  
                     <asp:ImageButton ID="LinkButton1"
                         CommandArgument='<%# Eval("TowingCompanyID") %>'  Width="23" BorderStyle="None"
