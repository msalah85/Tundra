<%@ Page Title=".:: Manage Clearance Companies ::." Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true" CodeFile="ClearanceCompaniesView.aspx.cs" Inherits="admin_elaf_ClearanceCompaniesView" %>
...
<tbody>
    <!-- Header -->
	<tr>
		<td class="innerContentHead">Clearance Companies >> View list<div class="div-right margin-right">
...
<!-- end search box -->
<center>   
<asp:GridView ID="gvClearanceCompanies" runat="server" AutoGenerateColumns="False" 
         Width="98%" CssClass="Grid" onrowcommand="gvClearanceCompanies_RowCommand" 
         PageSize="100" 
         onpageindexchanging="gvClearanceCompanies_PageIndexChanging" 
         onrowdeleting="gvClearanceCompanies_RowDeleting" >
        ...
        <Columns>
            ...
            <asp:TemplateField ItemStyle-Width="40">
                <ItemTemplate>                    
                        <asp:HyperLink ID="HyperLink11" runat="server" NavigateUrl='<%# "payments/" + Eval("ClearanceID") + "/clearance/" + MinutesuaeConcrete.ToSeoUrl(Eval("ClearanceName")) + ".aspx" %>' Width="23" BorderStyle="None"
            ...
            <asp:TemplateField ItemStyle-Width="40">
                <ItemTemplate>                    
                     <asp:ImageButton ID="lbEdit"
                         CommandArgument='<%# Eval("ClearanceID") %>' CssClass="showPeriodMsgPopup"  Width="23" BorderStyle="None"
            ...
            <asp:TemplateField HeaderText="Delete" ItemStyle-Width="40">
                 <ItemTemplate>                  
                     <asp:ImageButton ID="LinkButton1"
                         CommandArgument='<%# Eval("ClearanceID") %>'  Width="23" BorderStyle="None"
