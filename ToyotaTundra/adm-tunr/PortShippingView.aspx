<%@ Page Title=".:: View Port Shipping List ::." Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true" CodeFile="PortShippingView.aspx.cs" Inherits="admin_elaf_PortShippingView" %>
...
<tbody>
    <!-- Header -->
	<tr>
		<td class="innerContentHead">Port Shipping >> View list<div class="div-right margin-right">
...
<!-- end search box -->
<center>   
<asp:GridView ID="gvPortShips" runat="server" AutoGenerateColumns="False" 
         Width="98%" CssClass="Grid" onrowcommand="gvPortShips_RowCommand" 
         PageSize="100" 
         onpageindexchanging="gvPortShips_PageIndexChanging" 
         onrowdeleting="gvPortShips_RowDeleting" >
            ...
            <asp:TemplateField ItemStyle-Width="40">
                <ItemTemplate>                    
                        <asp:ImageButton ID="lbEdit"
                         CommandArgument='<%# Eval("PortShipID") %>' CssClass="showPeriodMsgPopup"  Width="23" BorderStyle="None"
            ...
            <asp:TemplateField HeaderText="Delete" ItemStyle-Width="40">
                 <ItemTemplate>                  
                     <asp:ImageButton ID="LinkButton1"
                         CommandArgument='<%# Eval("PortShipID") %>'  Width="23" BorderStyle="None"
