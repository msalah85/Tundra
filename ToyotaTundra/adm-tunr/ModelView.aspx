<%@ Page Title=".:: View Model List ::." Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true" CodeFile="ModelView.aspx.cs" Inherits="admin_elaf_ModelView" %>
...
<tbody>
    <!-- Header -->
	<tr>
		<td class="innerContentHead">Models >> View list<div class="div-right margin-right">
...
<tr>
    <td>Maker</td>
    <td>
        <asp:DropDownList ID="ddlMarkers" Width="258" runat="server"></asp:DropDownList>            
        &nbsp;<asp:RequiredFieldValidator  SetFocusOnError="true" CssClass="red-txt" ID="RequiredFieldValidator3" runat="server" 
		            ControlToValidate="ddlMarkers" ValidationGroup="s" InitialValue=""
            ...
            <asp:TemplateField ItemStyle-Width="40">
                <ItemTemplate>                    
                        <asp:ImageButton ID="lbEdit"
                         CommandArgument='<%# Eval("ModelID") %>' CssClass="showPeriodMsgPopup"  Width="23" BorderStyle="None"
            ...
            <asp:TemplateField HeaderText="Delete" ItemStyle-Width="40">
                 <ItemTemplate>                  
                     <asp:ImageButton ID="LinkButton1"
                         CommandArgument='<%# Eval("ModelID") %>'  Width="23" BorderStyle="None" ToolTip="Delete"
