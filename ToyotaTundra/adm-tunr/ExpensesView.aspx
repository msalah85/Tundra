<%@ Page Title=".:: View Company Expenses List ::." Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true" CodeFile="ExpensesView.aspx.cs" Inherits="admin_elaf_ExpensesView" %>
...
<script type="text/javascript" language="javascript">
    ...
    function callPrint() {
        ...
        printWindow.document.write("<center><h1> Company Expenses List </h1></center><br/><br/>" + printContent1.innerHTML);
...
<tbody>
    <!-- Header -->
	<tr>
		<td class="innerContentHead">Expenses to Company
            <asp:Literal ID="ltlCoName" runat="server"></asp:Literal> >> View list<div class="div-right margin-right">
        <asp:HyperLink runat="server" ID="linkAddExpense" NavigateUrl="PaymentsAddEdit.aspx" ToolTip="Add New Payment" ImageUrl="~/App_Themes/admin/images/add_check.png"></asp:HyperLink></div></td>
	</tr>
    <!-- Seperator -->
	<tr>
...
<tr align="center" valign="top" class="Grid_alertnative">
	<td>
        <asp:TextBox ID="txtExpenseDateFrom" ValidationGroup="s" runat="server" ></asp:TextBox>                           
        <ajaxToolkit:TextBoxWatermarkExtender ID="txtExpenseDateFrom_TextBoxWatermarkExtender" 
        ...
        <asp:TextBox ID="txtExpenseDateTo" ValidationGroup="s" runat="server" ></asp:TextBox> 
...
<center id="divResultToPrint"> 
    ...
    <table width="98%" class="Grid">
        ...
        <tr class="Grid_alertnative">
            ...
            <td width="25%" id="divTotalExpenses" runat="server"></td>
